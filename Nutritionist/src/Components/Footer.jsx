...
const Footer = () => {
  return (
    <div className="bg-[#1A3129] h-[299px]">
      <nav class="flex items-center p-16 mx-8">
        <img
          src="images/logo.png"
      ...
      <div className="bg-[#2C5446] h-[87px] rounded-lg shadow border border-[#356554] mx-28 flex items-center pl-5 ">
        ...
        <p className="text-white p-5 flex items-center">© 2023 Nutritionist. All rights reserved.  <BsFillArrowUpCircleFill style={{ color: "#CBEA7B" }} className="w-8 h-8 relative ml-5"/></p>
      </div>
    </div>
  );
};
